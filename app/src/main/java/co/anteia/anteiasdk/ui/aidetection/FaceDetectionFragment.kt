...
import co.anteia.anteiasdk.databinding.FragmentFaceDetectionBinding
...
class FaceDetectionFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            inflater,
            R.layout.fragment_face_detection, container, false
        )
    ...
    private fun sendFrame(croppedImage: Bitmap) {
        ...
        viewModel.sendFace(croppedImage).observe(requireActivity(),{
            it?.let { resource ->
